...
1. Cobrir as camadas service e route com testes unitários e alcançar 100% de code coverage
2. Manter 100% de code coverage e implementar testes e2e para toda a API
3. implementar testes unitários para o frontend e manter 100% de code coverage
- **PLUS**: 
